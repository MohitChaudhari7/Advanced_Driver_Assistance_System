...
void *HaarCar(void *threadp)
{
    ...
    CascadeClassifier car_data;
    if (!car_data.load("cars.xml")) 
    {
        cout << "Error loading car.xml" << endl;
        exit(-1);
    }
    ...
    while (!exit_flag) 
    {
        ...
        car_data.detectMultiScale(img_blur, found, 1.1,10, 0, cv::Size(70, 70));
        ...
        //     {
        //         rectangle(img, found[i], cv::Scalar(0, 255, 0), 5);
        //     }
        //     imshow("Output", img);
        // }
...
void *LaneDetection(void *threadp)
{
    ...
    while (frameNumber < NUM_FRAMES) 
    {
        ...
        char write_base[50] = "/home/mohit/ECV/final/haar_car/frame";
